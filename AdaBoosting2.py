# -*- coding: utf-8 -*-
"""
Created on Mon Feb 12 14:41:21 2024
...
data=pd.read_csv("D:/Data Science/6-Datasets/movies_classification.csv.xls")
...
#Our data is evenly distributed at least 200 arw there in both choice 
...
#Observations:
#here are more chances to getting oscar in Drama,comedy and Action genre
sns.countplot(x='3D_available',data=data,hue='Start_Tech_Oscar',palette='pastel')
plt.title('O chance based on ticket class', fontsize=10);

#Onservations:
#it is clear from the plot if 3d is available the there is chance of 
...
ax1.set(xlabel='Twitter_hastags',title='Distribution of Twitter_hastags and Collection based on target variable')

ax2=sns.histplot(x='Collection',data=data,hue='Start_Tech_Oscar',kde=True,ax=ax[1],palette='viridis')

ax2.set(xlabel='Distribtuion of Fare based on target variable')
